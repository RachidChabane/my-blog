...
Un chunk sensible à la structure est une unité autonome et sémantiquement cohérente [s1] : l'embedding apparie une unité entière et le générateur reçoit un contexte sur lequel il peut s'appuyer ; sur ce raisonnement, les 4,3 points sont la méthode qui fonctionne comme prévu, et la conclusion s'impose : toujours couper sur l'arbre.
