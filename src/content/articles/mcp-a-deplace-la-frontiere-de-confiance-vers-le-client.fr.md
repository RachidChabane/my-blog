...
title: MCP a gagné par la simplicité et déplacé la frontière de confiance vers le
  client
...
difficulty: 3
sources:
- label: Model Context Protocol Threat Modeling and Analyzing Vulnerabilities to Prompt
    Injection with Tool Poisoning (arXiv 2603.22489)
  url: https://arxiv.org/abs/2603.22489
  date: 23-03-2026
- label: 'Cloud Security Alliance, Research Note: MCP Security Crisis, Systemic Design
  ...
  date: 04-05-2026
contentHash: sha256:82115e5d0daa0311
