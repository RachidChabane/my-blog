...
name: 'Sterna'
summary: 'Un espace de travail IA multi-modèles, désormais open source sous AGPL-3.0 : chat multi-modèles côte à côte, agent de codage en sandbox avec un flux GitHub issue vers PR, base de connaissances RAG, connecteurs MCP, salles vocales et comptabilité des coûts par message.'
stack:
  - 'Python'
  - 'Django'
  - 'React'
...
year: '2025–2026'
highlights:
  - 'Open-sourcé sous AGPL-3.0 : backend Django/DRF complet, frontend React 19 + TypeScript, microservices FastAPI et infrastructure Kubernetes/Terraform'
...
Le cœur du produit était terminé environ huit mois avant la publication ; la suite n'a été que du polissage. Plutôt que de financer l'hébergement et l'astreinte qu'exige un SaaS public, j'ai choisi d'open-sourcer l'ensemble sous AGPL-3.0 — le code est le produit, auto-hébergeable depuis un seul fichier compose, avec des démos enregistrées de chaque fonctionnalité dans le dépôt.
