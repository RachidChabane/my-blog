...
def build_research_prompt(
    *,
    ...
    return (
        ...
        f"{avoid}"
        "\n"
        "NO-NEWS FALLBACK -- the LESSON path. After the sweep, make an explicit\n"
        "newsworthiness call: is at least one candidate GENUINELY worth covering\n"
        "today (recent, material to practitioners, with real engineering depth --\n"
        "not a rehash, a minor version bump, or marketing)? If NO candidate clears\n"
        "that bar, the run writes a LESSON instead of a news piece:\n"
        ...
        "    verbatim excerpts and two or more independent sources.\n"
